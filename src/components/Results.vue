    ...
    <div class="row">
            ...
            <div>
                <b-tabs card content-class="mt-3">
                    <b-tab>
                        <template #title>
                            Result1
                            <a href="#" class="hover-overlay" style="text-decoration: none; @hover: red;" >
        ...
        <div class="col-md-4 border-top-0 p-0">
            ...
            <ul class="list-group overflow-auto" style="max-height: 500px;">
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start border-0 border-bottom">
