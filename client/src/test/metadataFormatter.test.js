...
describe('insert', () => {
    ...
    test('apple', () => {
        expect(insert('An apple a day doctor away', ' keeps the', 14)).toBe('An apple a day keeps the doctor away')
    })
    test('empty insert', () => {
