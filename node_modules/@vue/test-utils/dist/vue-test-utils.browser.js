    ...
    ***************************************************************************** */
    ...
    var createStub = function (_a) {
        ...
        var render = function (ctx) {
            ...
            return Vue.h(tag, propsWithoutSymbols, renderStubDefaultSlot ? ctx.$slots : undefined);
        };
    ...
    function stubComponents(stubs, shallow, renderStubDefaultSlot) {
        ...
        Vue.transformVNodeArgs(function (args, instance) {
            ...
            if (type === Vue.Transition && 'transition' in stubs && stubs['transition']) {
                return [
            ...
            if (type === Vue.Teleport && 'teleport' in stubs && stubs['teleport']) {
                return [
                    createTeleportStub({
                        name: 'teleport-stub'
                    }),
